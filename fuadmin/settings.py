"""
Django's settings for fuadmin project.
...
WHITE_LIST = ['/api/system/userinfo', '/api/system/permCode', '/api/system/menu/route/tree', '/api/system/user/*',
              '/api/system/user/set/repassword','/api/system/product','/api/system/chipType/list/*','/api/system/category/list/*','/api/system/version/list/*','/api/system/ScheduledTasks','/api/system/case']
...
EMAIL_HOST = 'smtp.mxhichina.com'# 服务器名称
EMAIL_PORT = 465# 服务端口
EMAIL_HOST_USER = 'noreply@possumic.com' # 填写自己邮箱
EMAIL_HOST_PASSWORD = 'Nrpy@i5i6#24'# 在邮箱中设置的客户端授权密码
EMAIL_FROM = 'test'# 收件人看到的发件人
